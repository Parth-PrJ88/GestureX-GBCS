...
const overviewHTML = `
    ...
    <div class="guide-section">
        <h3>🎥 Quick 2-Min Intro</h3>
        <div class="video-card">
            <div class="video-preview">
                <video id="quickStartVideo" preload="metadata" controls controlsList="nodownload">
                    <source src="/static/videos/Tour-Modal-Overview.mp4" type="video/mp4">
                </video>
            </div>
        </div>
        <p class="video-caption">
            Learn GestureX in just 2 minutes.
        </p>
    </div>
`;
...
const alignmentHTML = `
    ...
    <div class="guide-card">
        ...
        <button class="guide-video-btn" onclick="openTutorial('/static/videos/Tour-Modal-Overview.mp4')">
...
const cursorHTML = `
    ...
    <div class="guide-card">
        <h3>🎥 Video Tutorial</h3>
        <button class="guide-video-btn" onclick="openTutorial('/static/videos/Cursor-Control-Tutorial.mp4')">
...
const profilesHTML = `
    ...
    <div class="guide-card">
        <h3>🎥 Video Tutorial</h3>
        <button class="guide-video-btn" onclick="openTutorial('/static/videos/Profile-Management-Tutorial.mp4')">
            ▶ Watch Profile Management Tutorial
        </button>
    </div>
...
const tutorialsHTML = `
    ...
    <div class="tutorial-grid">
        <div class="tutorial-card">
            <h3>🎯 Alignment</h3>
            <p>Camera positioning & Face alignment.</p>
        ...
        <div class="tutorial-card">
            <h3>👤 Profile </h3>
            <p>Save, Load, Rename & Delete Profiles.</p>
            <button class="guide-video-btn">
                ▶ Watch
            </button>
        </div>
        ...
        <div class="tutorial-card">
            ...
            <p>Gestures for Control the Cursor.</p>
            <button class="guide-video-btn">
                ▶ Watch
            </button>
        </div>
...
function loadGuidePage(page){
    ...
    const oldVideo = document.getElementById("quickStartVideo");
...
function openTutorial(video){
    window.open(video,"_blank");
    // const win = window.open(video, "_blank", "noopener,noreferrer");
    // if (win) {
    //     win.focus();
    // }
}
function toggleQuickStartVideo(){
    const video=document.getElementById("quickStartVideo");
    const playBtn=document.querySelector(".video-play-btn i");
    if(video.paused){
        video.play();
    }
    else{
...
function showTourStep(index){
    ...
    // Hide "Previous" button on the step-1
    tourPrev.style.opacity = (index === 0) ? "0" : "";
    // Change "Next" button to "Finish" on the last step
    tourNext.innerText = (index === tourSteps.length - 1) ? "Finish" : "Next →";
    /* ---------------------------------------------- */
